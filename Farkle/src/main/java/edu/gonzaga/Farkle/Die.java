...
public DieStatusEnum dieStatus = DieStatusEnum.ISINHAND;

    // public Boolean isInHand = true;
    // public Boolean isInCurrentMeld = false;
    // public Boolean isInScoredMeld = false;

    // constructor initializes numSides and sideUp to defaults of 6 and 1
    public Die() 
    {
    ...
    // constructor allowing specification of number of sides and uses default side up of 1
    ...
    // constructor allowing specification of number of sides and starting side
